...
$options->moduleValues        = [
	QRMatrix::M_FINDER_DARK    => [247, 0, 0], // dark (true)
	QRMatrix::M_FINDER_DOT     => [247, 0, 0], // finder dot, dark (true)
	QRMatrix::M_FINDER         => [233, 233, 233], // light (false)
	QRMatrix::M_ALIGNMENT_DARK => [247, 0, 0],
	QRMatrix::M_ALIGNMENT      => [233, 233, 233],
	QRMatrix::M_DATA_DARK      => [247, 0, 0],
	QRMatrix::M_DATA           => [233, 233, 233],
	QRMatrix::M_TIMING_DARK    => [247, 0, 0],
	QRMatrix::M_FORMAT_DARK      => [247, 0, 0],
	QRMatrix::M_VERSION_DARK      => [247, 0, 0],
];
